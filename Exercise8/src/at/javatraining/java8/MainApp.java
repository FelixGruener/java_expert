...
public class MainApp {
	public static void main(String[] args) {
		List<Person> persons = Arrays.asList(
			new Person(1, "Josef", "Huber", LocalDate.of(1980, 1, 1), true, new Address(1, "Hauptstraße 1", "3270", "Scheibbs", "AT")),
			...
			new Person(4, "Franz", "Beckenbauer", LocalDate.of(1950, 2, 1), true, new Address(4, "Berliner Straße 123", "11111", "München", "DE")),
			new Person(5, "Claudia", "Berger", LocalDate.of(1970, 1, 3), true, new Address(5, "Weg 1", "22222", "Hamburg", "DE")),
			new Person(6, "Pierre", "Grüninger", LocalDate.of(1960, 1, 1), true, new Address(6, "Emerlingweg 12", "12121", "Zürich", "CH")),
			new Person(7, "Alexandra", "Grüninger", LocalDate.of(1962, 3, 1), true, new Address())
		);
